...
6.  To get started with the supervisely annotation tool, check out this [overview page](https://docs.supervise.ly/annotation/ "Opens in a new tab."){:target="_blank"}.
